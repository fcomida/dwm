...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,	XK_t,		        setlayout,	    {.v = &layouts[1]} }, /* "TTT",	 bstack  */
	{ MODKEY,			XK_y,		        setlayout,	    {.v = &layouts[2]} }, /* "[@]",	 spiral  */
	{ MODKEY|ShiftMask,	XK_y,		        setlayout,	    {.v = &layouts[3]} }, /* "[\\]", dwindle */
	{ MODKEY,			XK_u,		        setlayout,	    {.v = &layouts[4]} }, /* "H[]",	 deck*/
	{ MODKEY|ShiftMask,	XK_u,		        setlayout,	    {.v = &layouts[5]} }, /* "[M]",	 monocle */
	{ MODKEY,			XK_i,		        setlayout,	    {.v = &layouts[6]} }, /* "|M|",	 centeredmaster */
	{ MODKEY|ShiftMask,	XK_i,		        setlayout,	    {.v = &layouts[7]} }, /* ">M>",	 centeredfloatingmaster */
